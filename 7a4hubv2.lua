...
local Window = Fluent:CreateWindow({
    Title = "My Thuan A 7a4 Hub",
    SubTitle = "by Le Gia Bao 7a4",
    TabWidth = 160,
...
------Bypass TP 2
 ...
 if game.Players.LocalPlayer.Team then
  for i,v in pairs(game.Workspace._WorldOrigin.PlayerSpawns:FindFirstChild(tostring(game.Players.LocalPlayer.Team)):GetChildren()) do 
   ...
   if ReMagnitude < CheckInOut xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed> 0; wait(0.2)
    end
    local tweenfunc = {}
    local Distance = (RealTarget.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position)
        .Magnitude
    if Distance < 1000 xss=removed>= 1000 then
        Speed = 300
    end
    if BypassTP then
   ...
   if (p.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 2000 and not Auto_Raid and game.Players.LocalPlayer.Character.Humanoid.Health > 0 then
    ...
    elseif NameMon == "FrostQuest" then
     ...
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-6508.5581054688, 89.034996032715, -132.83953857422))
      ...
      game.Players.LocalPlayer.Character.Head:Destroy()
      game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p
     until (p.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 2500> 0
     wait()
    end
   end
  end)
    ...
    spawn(function()
        ...
        pcall(function()
          ...
          if BypassTP then
            ...
            BTP(CFrameQ)
            elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameQ.Position).Magnitude < 2500 xss=removed xss=removed> 0 then
          if v.Name == Ms then
          repeat wait(0)
                    ...
                    if (CFrame.new(-5539.3115234375, 313.800537109375, -2972.372314453125).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude &lt;= 500 then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if _G.CastleRaid and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                                if (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 2000 xss=removed xss=removed xss=removed xss=removed xss=removed> 2500 then
                        BTP(CFrameCastleRaid)
                        elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameCastleRaid.Position).Magnitude < 2500 xss=removed xss=removed Title = "Mastery Mode" xss=removed xss=removed xss=removed xss=removed xss=removed Title = "Auto BF Mastery" xss=removed xss=removed xss=removed Title = "Health (%) Mob" Description = "" xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed>= 1 then
...
spawn(function()
    ...
    pcall(function()
      ...
      if BypassTP then
        ...
        BTP(CFrameQ)
        wait(0.2)
        elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameQ.Position).Magnitude < 2500 xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed Title = "Auto Bone" xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed> 2500 then
                       BTP(BoneCFrame2)
                       elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - BoneCFrame.Position).Magnitude < 2500 xss=removed xss=removed> 0 then
   ...
   if _G.CakePrince then
                pcall(function()
                    ...
                    if BypassTP then
                        ...
                        BTP(CakeCFrame)
                        wait(3)
                        elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CakeCFrame.Position).Magnitude < 2000 xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed> 0 then
                                    repeat wait(0)
    ...
    spawn(function()
        ...
        pcall(function()
          ...
          if BypassTP then
            ...
            BTP(MPos)
            elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MPos.Position).Magnitude < 3500> 0 then
          if v.Name == MMon then
            repeat wait(0)
...
spawn(function()
  ...
  if _G.Auto_Buy_Chips_Dungeon then
   pcall(function()
    ...
    local ToggleStart = Tabs.Raid:AddToggle("ToggleStart", {Title = "Auto Start Raid", Default = false })
 ...
 Callback = function()
  ...
  for k, v in pairs(cac) do
   if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
    ...
    huhu.Image = "rbxassetid://79596005696447"
