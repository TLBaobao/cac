...
v0.new("<Color=Cyan>Welcome to 7a4 Roblox Hub<Color=/>"):Display();
wait(0.5);
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "7a4 Roblox Hub",
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=79596005696447&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
